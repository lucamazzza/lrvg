/**
 * @file    ovo_parser.cpp
 * @brief   OVO file parser implementation
 *
 * This file contains the implementation of the OVOParser class, which is responsible for parsing
...
// Static member initialization - Material library used during OVO parsing
